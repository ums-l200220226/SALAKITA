        ...
        <div class="flex flex-col md:flex-row items-start md:items-center gap-4 sm:gap-6">
            ...
            <div class="flex-1 w-full">
                ...
                <div class="flex items-center gap-2 text-xs sm:text-sm text-gray-500 mb-2">
                    <a href="{{ route('superAdmin.tokoPetani') }}" class="hover:text-[#4a7c2c] transition">Daftar Toko</a>
        ...
        <div class="bg-white rounded-lg sm:rounded-xl shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-300 overflow-hidden group product-card"
            ...
            <div class="relative overflow-hidden">
                <img src="{{ $product->gambar ? asset('storage/' . $product->gambar) : '/img/placeholder.jpg' }}"
                    ...
                    onerror="this.src='data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22200%22 height=%22200%22%3E%3Crect fill=%22%23f5f1e8%22 width=%22200%22 height=%22200%22/%3E%3Ctext fill=%22%23999%22 font-family=%22sans-serif%22 font-size=%2218%22 dy=%2210.5%25%22 font-weight=%22bold%22 x=%2250%25%22 y=%2250%25%22 text-anchor=%22middle%22%3ENo Image%3C/text%3E%3C/svg%3E'">
            ...
            <div class="p-2.5 sm:p-4">
                ...
                <!-- Info Badge -->
                <div class="w-full bg-[#f5f1e8] text-[#2d5016] py-1.5 sm:py-2 rounded-lg text-[10px] sm:text-sm font-semibold text-center">
                    Produk Toko
                </div>
            </div>
        </div>
