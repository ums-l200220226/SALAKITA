    ...
    <div class="container mx-auto px-4">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div>
                ...
                <p class="text-xs sm:text-sm md:text-base text-gray-600">Kelola dan pantau toko petani yang terdaftar</p>
            </div>
...
<div class="container mx-auto px-4 pb-12">
    ...
    <div id="tokoGrid" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-4">
        ...
        <a href="{{ route('superAdmin.toko.show', $toko->id) }}" class="block group">
